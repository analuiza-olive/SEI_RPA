...
Uso:
    python 00_agrupar_procedimentos.py                          # usa o arquivo padrão abaixo
    python 00_agrupar_procedimentos.py minha_planilha.xlsx      # passa o arquivo por argumento
    python 00_agrupar_procedimentos.py planilha.xlsx --formato excel   # saída em Excel
    python 00_agrupar_procedimentos.py planilha.xlsx --formato txt     # saída em TXT (padrão)
"""
...
def carregar_dados(caminho: str) -> pd.DataFrame:
    ...
    if antes != depois:
        print(
            f"  ⚠  {antes - depois} linha(s) ignorada(s) por ter célula vazia em delegado/delegacia/procedimento."
        )
...
def main():
    ...
    print(f"\n💾 Salvando resultado...")
    if formato == "excel":
        saida = f"{base}_procedimentos_{hoje}.xlsx"
